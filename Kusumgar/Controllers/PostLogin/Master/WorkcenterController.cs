    ...
    public class WorkCenterController : Controller
    {
        ...
        public ActionResult Index(WorkCenterViewModel wcViewModel)
        {
            ...
            try
            {
                ...
                //wcViewModel.Work_Center.Work_Stations = _workcenterMan.Get_Work_Stations_By_Factory_Id(wcViewModel.Work_Center.Work_Center_Entity.Work_Station_Id, ref pager);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult Insert(WorkCenterViewModel wcViewModel)
        {
            try
            {
                wcViewModel.Work_Center.Work_Center_Entity.CreatedOn = DateTime.Now;

                wcViewModel.Work_Center.Work_Center_Entity.CreatedBy = ((EmployeeInfo)Session["User"]).EmployeeId;

                wcViewModel.Work_Center.Work_Center_Entity.UpdatedOn = DateTime.Now;

                wcViewModel.Work_Center.Work_Center_Entity.UpdatedBy = ((EmployeeInfo)Session["User"]).EmployeeId;
